...
export class TagModule extends BaseModule {
   ...
   */
  public async getInfo(tag: string, lang?: string): Promise<Types.TagInfoResponse> {
   ...
   */
  public async getWeeklyChartList(tag: string): Promise<Types.WeeklyChartListResponse> {
